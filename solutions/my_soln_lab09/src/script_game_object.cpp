...
PyTypeObject GameObjectType =
{
    ...
    sizeof(ssuge::script::GameObject),                      // tp_size: size (in bytes) of our Object
    0,                                                      // tp_itemsize

    /* Methods to implement standard operations */
    (destructor)ssuge::script::GameObject_dealloc,           // tp_dealloc
    ...
    (initproc)ssuge::script::GameObject_init,               // tp_init;
    NULL,                                                   // tp_alloc;
    ssuge::script::GameObject_new,                          // tp_new;
